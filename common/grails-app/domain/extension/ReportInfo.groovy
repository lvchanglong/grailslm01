...
class ReportInfo {
    ...
    String getGdxxHtml() {
        ...
        this.gdxxs.eachWithIndex{ entry, i ->
            sb.append("<tr><td>${i + 1}</td><td>${entry.dwhzrr}</td><td>${entry.tzje}</td><td>${entry.tzbl}</td></tr>")
        }
        sb.append("</table>")
        return sb.toString()
    }
    ...
    String getLsygHtml() {
        ...
        this.lsygs.eachWithIndex{ entry, i ->
            sb.append("<tr><td>${i + 1}</td><td>${entry.bgqmc}</td><td>${entry.bghmc}</td><td>${entry.pzsj}</td></tr>")
        }
        sb.append("</table>")
        return sb.toString()
    }
    ...
    String getFzjgHtml() {
        ...
        this.fzjgs.eachWithIndex{ entry, i ->
            sb.append("<tr><td>${i + 1}</td><td>${entry.ybgqygx}</td><td>${entry.qymc}</td><td>${entry.dz}</td><td>${entry.lxdh}</td></tr>")
        }
        sb.append("</table>")
        return sb.toString()
    }
    ...
    String getGgryszHtml() {
        ...
        this.ggryszs.eachWithIndex{ entry, i ->
            sb.append("<tr><td>${i + 1}</td><td>${entry.xm}</td><td>${entry.zw}</td><td>${entry.nl}</td><td>${entry.xljzc}</td><td>${entry.cyzz}</td><td>${entry.hjqk}</td></tr>")
        }
        sb.append("</table>")
        return sb.toString()
    }
