...
<a href="#fakelink" data-toggle="modal" data-target="#editCompanyModal${instance.id}">
    <span class="glyphicon glyphicon-edit" data-toggle="tooltip" title="修改"></span>
</a>

<div class="modal fade" id="editCompanyModal${instance.id}" tabindex="-1" role="dialog" aria-labelledby="editCompanyModal${instance.id}Title" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <g:form name="editCompanyForm${instance.id}" url="[controller:params.controller, action: 'update', id:instance.id]" class="form-horizontal ajaxForm">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h3 class="modal-title" id="editCompanyModal${instance.id}Title">信息修改</h3>
                </div>
                <div class="modal-body">
                    <fieldset class="modal-fieldset">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <g:textField name="contactText" id="companyContact${instance.id}" value="${instance.contact?.getUniqueKey()}" class="form-control" autocomplete="off"/>
                                <script>
                                    jQuery("#companyContact${instance.id}").typeahead({
                                        minLength:0,
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <g:textField name="actualContactText" id="companyActualContact${instance.id}" value="${instance.actualContact?.getUniqueKey()}" class="form-control" autocomplete="off"/>
                                <script>
                                    jQuery("#companyActualContact${instance.id}").typeahead({
                                        minLength:0,
                                        showHintOnFocus:true,
                                        source:function(query, process) {
                                            return jQuery.get("${createLink(controller:params.controller, action:'listContacts')}", {query: query}, function (data) {
