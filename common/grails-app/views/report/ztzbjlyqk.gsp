                ...
                <div class="col-md-12">
                    <g:form name="reportForm" controller="report" action="update" id="${report.id}" class="ajaxForm">
                        <table border="0" cellpadding="0" cellspacing="0" class="table table-bordered">
                            <tr>
                                <th class="info">招标投标领域重点建设项目中标及履约情况：</th>
                            </tr>
                            <tr>
                                <td class="form_td p5 tl h20 lh20">
                                    <ckeditor:editor name="info.ztzbjlyqk" id="createInfoZtzbjlyqk" width="100%" height="370px" userSpace="${vip.username}">
                                        ${reportInfo.ztzbjlyqk}
                                    </ckeditor:editor>
                                </td>
                            </tr>
                        </table>
