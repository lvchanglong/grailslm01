                    ...
                    <g:form name="reportForm" controller="report" action="update" id="${report.id}" class="ajaxForm">
                        <table border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <g:textField name="info.xjllb.nf3" value="${reportInfo.xjllb?.nf3?:"${year - 3}"}" class="form-control" placeholder="如：2015"/>
                                </td>
                                <td>
                                    <g:textField name="info.xjllb.nf2" value="${reportInfo.xjllb?.nf2?:"${year - 2}"}" class="form-control" placeholder="如：2016"/>
                                </td>
                                <td>
                                    <g:textField name="info.xjllb.nf1" value="${reportInfo.xjllb?.nf1?:"${year - 1}"}" class="form-control" placeholder="如：2017"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
